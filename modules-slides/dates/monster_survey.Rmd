...
generate the survey dates for each island. But we need to know which day to start from.
...
Oh no! Each survey island has a very-very particular **Assistant to the Regional Manager**. And they are demanding a very **specific** date format be used for their work schedules. 
...
```{r, eval=F}
monsters <- read_csv("https://tidy-mn.github.io/R-camp-penguins/data/2024_monster_survey_results.csv")   
```
